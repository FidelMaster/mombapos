class ExchangeRatesController < ApplicationController
  ...
  def update
    if @exchange_rate.update(exchange_rate_params)
      redirect_to @exchange_rate, notice: "Exchange rate was successfully updated.", status: :see_other
    else
  ...
  def destroy
    ...
    redirect_to exchange_rates_url, notice: "Exchange rate was successfully destroyed.", status: :see_other
  end
  ...
  private
    ...
    def exchange_rate_params
      params.require(:exchange_rate).permit(:currency, :rate, :effective_date)
    end
end
